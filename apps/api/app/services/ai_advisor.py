...
def _llm_compact_context(context: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "holdings_snapshot": {
            ...
            "profit_factor": holdings_snapshot.get("profit_factor"),
            "cagr": holdings_snapshot.get("cagr"),
            "r_expectancy": holdings_snapshot.get("r_expectancy"),
            "mae": holdings_snapshot.get("mae"),
...
async def build_ai_context(
    ...
    return {
        ...
        "holdings_totals": {
            ...
            "sharpe_30d": holdings_snapshot_dict.get("sharpe_30d"),
            "sortino_30d": holdings_snapshot_dict.get("sortino_30d"),
            "profit_factor": holdings_snapshot_dict.get("profit_factor"),
            "cagr": holdings_snapshot_dict.get("cagr"),
            "r_expectancy": holdings_snapshot_dict.get("r_expectancy"),
            "mae": holdings_snapshot_dict.get("mae"),
            "mfe": holdings_snapshot_dict.get("mfe"),
        },
